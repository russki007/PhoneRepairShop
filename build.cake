...
const string PackageName = "PhoneRepairShop";
...
public static class Paths {
       ...
       public static FilePath ProjectFile => $"{SrcDir}/PhoneRepairShop/PhoneRepairShop.csproj";
	...
	.Does(() => 
{
	...
	var packageDescription = $"PhoneRepairShop v{version}";
